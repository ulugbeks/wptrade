...
// ACF поля для страницы услуг
$service_price = get_field('service_page_price');
$service_period = get_field('service_page_period');
$sidebar_text = get_field('service_page_sidebar_text');
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                <div class="education-sidebar ml_10">
                    <div class="sidebar-widget">
                        ...
                        <?php else: ?>
                        <div class="sidebar-text mb_30">
                            <p>Получите профессиональную консультацию и поддержку от наших экспертов.</p>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="btn-box">
                            <?php if(is_user_logged_in()): ?>
                                <button class="theme-btn btn-one w-100" id="buy-service-btn" 
                                    ...
                                    data-service-price="<?php echo esc_attr($service_price ?: 100); ?>">
                                    Купить услугу
                                </button>
                            <?php else: ?>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="service-info mb_20">
                <h4><?php the_title(); ?></h4>
                <p class="price-display">Стоимость: <strong><span id="modal-price"><?php echo esc_html($service_price ?: 100); ?></span> $</strong></p>
            </div>
            
            <form id="service-payment-form">
                <input type="hidden" name="service_name" value="<?php echo esc_attr(get_the_title()); ?>">
                <input type="hidden" name="amount" id="form-amount" value="<?php echo esc_attr($service_price ?: 100); ?>">
                <input type="hidden" name="page_id" value="<?php echo get_the_ID(); ?>">
                
                <div class="crypto-payment-info">
                    <h4>Оплата в USDT (TRC20)</h4>
                    <p>Отправьте <strong><span id="crypto-amount"><?php echo esc_html($service_price ?: 100); ?></span> USDT</strong> на адрес:</p>
...
jQuery(document).ready(function($) {
    ...
    $('#service-payment-form').on('submit', function(e) {
        ...
        formData += '&action=submit_service_page_payment';
